...
#加载客户端配置模板
clientjsonfile = file("/usr/local/V2Proxy/json_template/client.json")
...
clientconfig[u"outbound"][u"settings"][u"vnext"][0][u"users"][0][u"alterId"]=int(readjson.ConfAlterId)
